...
/*
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______,  KC_L,     KC_O,     KC_Y,     KC_K,     KC_G,                          KC_F5,    _______,  _______,  _______,  _______,  ALTF4,
    _______,  TO(QWERTY), _______,  _______,  KC_5,     KC_6,     _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,
